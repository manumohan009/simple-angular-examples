...
@Component({
  selector: 'app-rxjs-simple-examples',
  templateUrl: './rxjs-simple-examples.component.html',
  styleUrls: ['./rxjs-simple-examples.component.css']
})
export class RxjsSimpleExamplesComponent implements OnInit, AfterViewInit {
